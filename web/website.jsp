...
<header>
  <div class="headtop">
    <div class="timer box"><span><a onclick="javascript:window.external.addFavorite(window.location,'')" href="/">加入收藏</a> | <a onclick="this.style.behavior='url(#default#homepage)';this.setHomePage(window.location);" href="/">设为首页</a></span><script type="text/javascript" src="js/timer.js"></script></div>
  </div>
    ...
    <ul>
      ...
      <div class="center_news right">
        <section class="c_n_top">
          ...
          <p>10月17日下午，广安区卫计局举办了以“助人为乐”为主题的“道德讲堂”活动。使全体干部职工再一次受到了心灵的洗礼....[<a href="/" target="_blank">详情</a>]</p>
        </section>
        <ul>
          <li><a href="/" target="_blank">广安区喜摘全市人口计生统计与信息岗位技能竞赛桂冠<img src="images/new.gif"></a></li>
          <li><a href="/" target="_blank">广安区卫计局开展“道德讲堂”活动<img src="images/new.gif"></a></li>
